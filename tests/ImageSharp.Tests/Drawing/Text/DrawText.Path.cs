...
namespace ImageSharp.Tests.Drawing.Text
{
    ...
    public class DrawText_Path : IDisposable
    {
        ...
        {
            this.img.Mutate(x => x.DrawText("123", this.Font, Brushes.Solid(Color.Red), null, path));
        ...
        {
            this.img.Mutate(x => x.DrawText("123", this.Font, Brushes.Solid(Color.Red), path, new TextGraphicsOptions(true)));
        ...
        {
            this.img.Mutate(x => x.DrawText("123", this.Font, Brushes.Solid(Color.Red), path));
        ...
        {
            this.img.Mutate(x => x.DrawText("123", this.Font, Color.Red, path, new TextGraphicsOptions(true)));
        ...
        {
            this.img.Mutate(x => x.DrawText("123", this.Font, Color.Red, path));
        ...
        {
            this.img.Mutate(x => x.DrawText("123", this.Font, null, Pens.Dash(Color.Red, 1), path));
        ...
        {
            this.img.Mutate(x => x.DrawText("123", this.Font, Pens.Dash(Color.Red, 1), path, new TextGraphicsOptions(true)));
        ...
        {
            this.img.Mutate(x => x.DrawText("123", this.Font, Pens.Dash(Color.Red, 1), path));
        ...
        {
            this.img.Mutate(x => x.DrawText("123", this.Font, Brushes.Solid(Color.Red), Pens.Dash(Color.Red, 1), path));
        ...
        {
            this.img.Mutate(x => x.DrawText("1", this.Font, Brushes.Solid(Color.Red), Pens.Dash(Color.Red, 1), path));
