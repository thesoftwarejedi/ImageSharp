// <copyright file="BasePixelQuantizer{TPixel}.cs" company="James Jackson-South">
...
namespace ImageSharp.Quantizers
{
    ...
    internal abstract class BasePixelQuantizer<TPixel>
        where TPixel : struct, IPixel<TPixel>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BasePixelQuantizer{TPixel}"/> class.
        /// </summary>
        ...
        /// </remarks>
        protected BasePixelQuantizer(bool singlePass)
        {
