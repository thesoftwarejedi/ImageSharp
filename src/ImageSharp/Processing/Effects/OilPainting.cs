...
namespace ImageSharp
{
    ...
    public static partial class ImageExtensions
    {
        ...
        public static IImageOperations OilPaint(this IImageOperations source)
        {
        ...
        /// </param>
        /// <returns>The <see cref="Image{TPixel}"/>.</returns>
        public static IImageOperations OilPaint(this IImageOperations source, Rectangle rectangle)
        {
        ...
        /// <returns>The <see cref="Image{TPixel}"/>.</returns>
        public static IImageOperations OilPaint(this IImageOperations source, int levels, int brushSize)
        ...
        /// </param>
        /// <returns>The <see cref="Image{TPixel}"/>.</returns>
        public static IImageOperations OilPaint(this IImageOperations source, int levels, int brushSize, Rectangle rectangle)
