...
namespace ImageSharp.Drawing.Brushes
{
    ...
    /// </summary>
    public class RecolorBrush : Brush
    {
        /// <summary>
        ...
        public RecolorBrush(Color sourceColor, Color targeTPixel, float threshold)
        {
        ...
        {
            return new RecolorBrushApplicator<TPixel>(source, this.SourceColor.As<TPixel>(), this.TargeTPixel.As<TPixel>(), this.Threshold, options);
        }
